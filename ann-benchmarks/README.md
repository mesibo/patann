...
Modified ann-benchmarks addressing issues identified in https://patann.dev/benchmarks/benchmark-environment/

This branch also includes other cosmetic enhancements.
